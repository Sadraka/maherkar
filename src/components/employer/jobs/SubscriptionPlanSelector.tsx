...
/**
 * کامپوننت انتخاب طرح اشتراک - با استایل داشبورد کارفرما
 */
        ...
        >
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: { xs: 1.5, sm: 2 } }}>
            ...
            <Box sx={{ 
              ...
              <Box sx={{ flex: 1 }}>
                <Typography variant="body1" fontWeight="600" sx={{ fontSize: { xs: '1rem', sm: '1.1rem' } }}>
                  {selectedPlan.name}
                </Typography>
                <Typography variant="body2" color="text.secondary" sx={{ fontSize: { xs: '0.85rem', sm: '0.875rem' } }}>
                  {toPersianDigits(activeDuration)} روز
            {useCustomDuration && ' (دلخواه)'}
          </Typography>
              </Box>
              <Chip
                label={getPlanInfo(selectedPlan).badge}
                size="small"
                sx={{
                  bgcolor: getPlanInfo(selectedPlan).color,
                  color: 'white',
                  fontWeight: 'bold',
          ...
          <Box sx={{ 
            ...
            justifyContent: 'space-between',
                  ...
                  <Typography variant="body1" fontWeight="600" sx={{ 
                    ...
                    {toPersianDigits(calculateBasePrice(selectedPlan, activeDuration).toLocaleString())} تومان
            </Typography>
          </Box>
            ...
            <Box sx={{ 
                ...
                justifyContent: 'space-between',
                  ...
                  <Typography variant="body1" color="text.secondary" sx={{ 
                    ...
                    {toPersianDigits(calculateTax(selectedPlan, activeDuration).toLocaleString())} تومان
                </Typography>
              </Box>

              {/* خط جداکننده */}
              <Box sx={{ 
                  borderTop: '2px solid rgba(66,133,244,0.2)',
                  pt: 2,
                  mt: 1
              }}>
                <Box sx={{ 
                  ...
                  justifyContent: 'space-between',
                    ...
                    <Typography variant="h5" fontWeight="bold" color="primary" sx={{ 
                      ...
                      {toPersianDigits(calculatePrice(selectedPlan, activeDuration).toLocaleString())} تومان
              </Typography>
                </Box>
              </Box>
              </>
